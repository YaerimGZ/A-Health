  ...
  render() {
    ...
    return (
      ...
      <View style={styles.container}>
        ...
        <Text style={[styles.question]}>Dizzy or lightheaded</Text>

        <View>

          <TouchableOpacity onPress = {() => {this.props.navigation.navigate('Test3', {nameTest: TestName})}} style={[styles.menuOption, {marginRight: 20}]}>
