  ...
  render() {
    ...
    return (
      ...
      <View style={styles.container}>
        ...
        <Text style={[styles.question]}>Faint-lightheaded</Text>

        <View>

          <TouchableOpacity onPress = {() => {this.props.navigation.navigate('Results', {nameTest: TestName, username: Username})}} style={[styles.menuOption, {marginRight: 20}]}>
