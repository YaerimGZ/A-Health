  ...
  render() {
    ...
    return (
      ...
      <View style={styles.container}>
        ...
        <Text style={[styles.question]}>Face flushed</Text>

        <View>

          <TouchableOpacity onPress = {() => {this.props.navigation.navigate('Test4', {nameTest: TestName, username: Username})}} style={[styles.menuOption, {marginRight: 20}]}>
